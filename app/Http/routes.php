...
Route::post	 ('/Transaction/{id}/withdraw/{amount}'			, 'testCon@addWithdraw' 	);//insert transaction (withdraw) for selection account
Route::post	 ('/Transaction/{id}/deposite/{amount}'			, 'testCon@addDeposite' 	);//insert transaction (deposite) for selection account
Route::post	 ('/Transaction/{id}/transfer/{id2}/{amount}'	, 'testCon@addTransfer' 	);//insert transaction (transfer) for selection account
...
Route::get   ('/ATM/{aid}'									, 'testCon@getATM' 			);//get money in selection ATM
Route::put	 ('/ATM/{aid}/withdraw/{id}/{amount}'			, 'testCon@withdrawATM'		);//withdraw money in selection ATM
Route::put	 ('/ATM/{aid}/deposite/{id}/{amount}'			, 'testCon@depositeATM'		);//deposite money in selection ATM
Route::delete('/ATM'										, 'testCon@removeAllATM'	);//delete all ATM
Route::delete('/ATM/{aid}'									, 'testCon@removeATM' 		);//delete selection ATM